...
namespace Uyg.API.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        {
            var identityResult = await _userManager.CreateAsync(new() { UserName = dto.UserName, Email = dto.Email, FullName = dto.FullName, PhoneNumber = dto.PhoneNumber,PhotoUrl = ""}, dto.Password);
